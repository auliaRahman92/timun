function rand(max) {
  ...
  function displayVictoryMess(moves) {
    document.getElementById("moves").innerHTML = "Kamu gerak " + moves + " Langkah.";
  ...
  function initMobileControls() {
    const buttons = {
        'up-btn': 38,    // Up arrow key code
        'down-btn': 40,  // Down arrow key code
        'left-btn': 37,  // Left arrow key code
        'right-btn': 39  // Right arrow key code
    };
            ...
            button.addEventListener(eventType, (e) => {
                ...
                const keyEvent = new KeyboardEvent('keydown', {
                    ...
                    key: ['ArrowUp', 'ArrowDown', 'ArrowLeft', 'ArrowRight'][
                        Object.values(buttons).indexOf(keyCode)
                    ],
                    bubbles: true
                });
